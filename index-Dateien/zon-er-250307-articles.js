(function() {
    ...
    if (
        ...
        const executeIndividualArticleHacks = () => {
            ...
            if (window.location.href.indexOf("47-jahre-alter-lebensstil-karriere") !== -1 && document.querySelector("#paywall")){
                const restyleHeader =()=>{
                    let hackStyleTag = document.createElement('style');
                    ...
                    headerInner.innerHTML = '<span>Mit</span><span><img src="https://img.zeit.de/2025/10/zwe-mitxx-47/original__500x500" srcset="https://img.zeit.de/2025/10/zwe-mitxx-47/original__500x500 1x, https://img.zeit.de/2025/10/zwe-mitxx-47/original__500x500__scale_2 2x"></span>';
                }
